 ...
 */
final class Version20250930133315 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE actor ADD bio LONGTEXT DEFAULT NULL, CHANGE dod dod DATE DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE actor DROP bio, CHANGE dod dod VARCHAR(255) DEFAULT NULL');
    }
}
